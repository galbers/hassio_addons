...
## [0.1.28]
- Add configurable RTL-SDR target based on serial number of device

## [0.1.27]
- Update CO2 and Plug state sensor types

## [0.1.26]
- Added external plug state and attempt fix for PM10 and CO2 sensor

## [0.1.25]
- Added CO2 and additional PM10 sensor
